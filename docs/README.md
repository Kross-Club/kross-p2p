...
| [`15-REFERIDOS.md`](./15-REFERIDOS.md) | Programa de referidos (sep-2026): un solo nivel a suscriptores activos; qué cuesta un S/0.20 por cobro contra el margen real de cada riel, la recomendación y la simulación tienda demo vs típica (`node scripts/simular-referidos.mjs`) |
