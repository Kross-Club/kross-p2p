...
| **4 · Marca y web pública** | *Cómo se ve* y *qué dice* hacia fuera | [`10-MANUAL-DE-MARCA.md`](./10-MANUAL-DE-MARCA.md), [`04-CUMPLIMIENTO-WEB.md`](./04-CUMPLIMIENTO-WEB.md), [`figma/checkout-flow/`](./figma/checkout-flow/) (las vistas del checkout, paso por paso y condicional por condicional, para importar en Figma) |
