...
**Qué pasó.** Kross depende de 14 APIs de terceros y, cuando una fallaba, el error moría en un
...
> ⚠️ `pay360-webhook`, `flow-confirm` y `shalom-webhook` van con `--no-verify-jwt`, como
> siempre.
>
