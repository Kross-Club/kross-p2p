...
export default function Pay360Box({ coupon }: { coupon: CouponRef }) {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-4">
      ...
      <p className="mt-1 text-xs text-gray-500">{COPY.pay360Intro}</p>
      ...
      {/* Respaldo SIEMPRE visible: en desktop es el camino principal, no el
          plan B. Decirle "ábrelo en tu celular" a quien compra desde la PC es
          un callejón sin salida en el paso del cobro. */}
      <div className="mt-4 border-t border-gray-100 pt-3">
        <span className="text-[11px] font-bold uppercase tracking-wide text-gray-400">
          {COPY.pay360CodeLabel}
        </span>
