...
import { Upload, Gift, Copy, TrendingUp, Send } from 'lucide-react'
...
export default function ClientesInvitar() {
  ...
  return (
    <div className="px-4 pt-3 pb-4">
      <p className="text-xs text-gray-400 mb-4">Trae a la app la base que ya tienes, para poder escribirle.</p>
