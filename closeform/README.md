...
Landing de **alta conversión** con quiz guiado (texto / IA / audio) que **cierra** al
lead. Stack probado: **React + Vite + Tailwind + Supabase Edge Functions**, con
integraciones de **LiveKit** (voz + grabación), **WhatsApp Cloud API** (fallback),
**Web Push** e **IA**.
