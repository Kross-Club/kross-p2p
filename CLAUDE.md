...
| `docs/15-REFERIDOS.md` | **Programa de referidos** (sep-2026): un solo nivel a suscriptores activos; por qué el take de Kross es el cobro y no la suscripción, qué se lleva un S/0.20 por cobro según la tasa de Flow, la recomendación (20 % de la suscripción + S/0.10 por cobro + primer mes al 50 %) y la simulación tienda demo vs típica. Se recalcula con `node scripts/simular-referidos.mjs` |
