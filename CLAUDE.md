...
| `docs/13-CONEXIONES.md` | **Las APIs de terceros y sus fallos** (sep-2026): el catálogo de las 14 integraciones, la tabla `api_events` con su referencia `KX-…` para reclamarle al proveedor, y la pantalla *Panel → Conexiones*. Léelo antes de tocar cualquier llamada a un tercero |
