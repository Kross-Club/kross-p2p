...
| `docs/figma/checkout-flow/` | **Las vistas del checkout para Figma** (16-set-2026): 46 capturas de la app real (celular, 390 × 844 @2x), una por cada paso y cada condicional —Lima/provincia, domicilio/agencia, variante A/B, mitad, sin cobro en línea, fases del pago, salida—, el tablero `flujo-checkout.svg` con flechas y condiciones para importar de una vez, y el índice en su `README.md`. Se regeneran con `scripts/figma-checkout/` |
